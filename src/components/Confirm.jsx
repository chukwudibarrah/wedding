      ...
      <div className="bg-white p-10 w-11/12 md:w-4/12 rounded-lg">
        ...
        <form className="">
          <div className="font-merriweather text-sm leading-6 font-thin mb-7 text-slate-500 placeholder:text-slate-100">
            <input type="text" placeholder="Name" className="border-b-2 outline-orange-300 ring-orange-300 ring-offset-orange-300 w-full" />
          </div>
          <div className="font-merriweather text-sm leading-6 font-thin mb-7 text-slate-500 placeholder:text-slate-100">
            <input type="email" placeholder="Email"  className="border-b-2 w-full"/>
          </div>
          <div className="font-merriweather text-sm leading-6 font-thin mb-1 text-slate-500 placeholder:text-slate-100">
            ...
            <label htmlFor="yes" className="mx-2">Yes, I'll be there</label>
          </div>
          <div className="font-merriweather text-sm leading-6 font-thin mb-7 text-slate-500 placeholder:text-slate-100">
            <input type="radio" name="negative" value="sorry"/>
            <label htmlFor="sorry" className="mx-2">Sorry, I can't make it</label>
          </div>
          <div className="font-merriweather text-sm leading-6 font-thin mb-7 text-slate-500 placeholder:text-slate-100">
            <p>Number of guests:</p>
            <input type="number" placeholder="e.g., 1" className="border-b-2 w-full"/>
          </div>
          <div className="font-merriweather text-sm leading-6 font-thin mb-7 text-slate-500 placeholder:text-slate-100">
            <p>Meal preferences:</p>
            <select className="font-merriweather text-sm leading-6 font-thin text-slate-500 placeholder:text-slate-100 w-full">
          ...
          <div className="font-merriweather text-sm leading-6 font-thin mb-7 text-slate-500 ">
            ...
            <textarea className="border-2 placeholder:text-slate-100 w-full"></textarea>
          </div>
        </form>
      </div>
    </div>
